...
namespace Lecture2Guide.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyGuides_AspNetUsers_GeneratedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoTranscriptId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranscriptItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TranscriptItem_VideoTranscripts_VideoTranscriptId",
                        column: x => x.VideoTranscriptId,
                        principalTable: "VideoTranscripts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyGuides_GeneratedBy",
                table: "StudyGuides",
                column: "GeneratedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TranscriptItem_VideoTranscriptId",
                table: "TranscriptItem",
                column: "VideoTranscriptId");
        }
